...
<ReactPaginate
  ...
  pageLinkClassName={"px-3 py-2 inline-block text-gray-700 hover:text-gray-900"} // Added padding to the link
  ...
  previousLinkClassName={"px-3 py-2 inline-block text-gray-700 hover:text-gray-900"} // Added padding here
  nextLinkClassName={"px-3 py-2 inline-block text-gray-700 hover:text-gray-900"} // Added padding here
